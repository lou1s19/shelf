...
fn apply_liquid_glass_background_inner(
    ...
    unsafe {
        ...
        // which dims the material whenever another app window (camera, settings, etc.)
        ...
        // sampling while the app was unfocused, but an occlusion-suppressed surface is one
